...
<template>
    ...
    <v-locale-provider v-if="customizer.setRTLLayout" rtl>
        <v-app :theme="customizer.actTheme" class="bg-containerBg" :class="[
            customizer.actTheme,
            ...
            <v-main class="ml-md-4">
                <div class="mb-3 rtl-lyt hr-layout bg-containerBg">
                    <v-container fluid class="pt-6 page-wrapper bg-background rounded-xl">
                        <div class="">
                            <div :class="customizer.boxed ? 'maxWidth' : ''">
                                <RouterView v-slot="{ Component }">
                                    <transition name="fade" mode="out-in">
                                        <div :key="route.name ?? 'asd'">
        ...
        <v-app :theme="customizer.actTheme" class="bg-containerBg" :class="[
            ...
            <v-main class="mr-md-4">
                <div class="mb-3 hr-layout bg-containerBg">
                    <v-container fluid class="pt-12 page-wrapper bg-background rounded-xl">
                        <div class="px-sm-6">
                            <div :class="customizer.boxed ? 'maxWidth' : ''">
                                <RouterView v-slot="{ Component }">
                                    <transition name="fade" mode="out-in">
