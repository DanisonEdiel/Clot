...
import CompanyChanged from './CompanyChanged.vue';
import Navigations from '@/layouts/admin/full/vertical-header/Navigations.vue';
...
<template>
    <v-app-bar elevation="0" :priority="priority" height="70" class="main-head">
        ...
        <CompanyChanged />
        <v-btn icon class="primary" size="small"  @click="startTour" color="primary"><Icon icon="material-symbols-light:tour-outline" height="22"/></v-btn>
        <ThemeToggler />
        <div class="">
            <ProfileDD />
        </div>
...
<v-sheet rounded="lg" elevation="10" class="px-4 py-3 mt-4 dropdown-box">
    <div class="d-flex tw-justify-end align-center">
        <ProfileDD />
    </div>
</v-sheet>
</v-menu> -->
